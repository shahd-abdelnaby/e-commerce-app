...
export default function Profile() {
  ...
  return (
    <>
      <div className="card w-[90] mx-auto my-15 flex justify-center align-middle flex-col p-4  bg-gray-100 shadow-lg rounded-lg">
        ...
        <div className="card__avatar -my-12 mx-auto w-32 h-32 rounded-full bg-white p-1 shadow-lg">
        ...
        <div className="card__title">{session?.user?.name}</div>
        <div className="card__subtitle">{session?.user?.email}</div>
        <div className="card__wrapper flex justify-between gap-4 my-4 flex-wrap">
          <Link href="/allorders" className="card__btn text-white bg-pink-900 p-2 rounded-tr-lg  hover:bg-pink-950 cursor-pointer">My Orders <i className="fa-regular fa-credit-card"></i></Link>
          <Link href="/WhishList" className="card__btn text-white bg-pink-900 p-2 rounded-tr-lg  hover:bg-pink-950 cursor-pointer">WishList <i className="fa-regular fa-heart"></i></Link>
          <Link href="/ForgotPassword" className="card__btn mx-7 text-white bg-pink-900 p-2 rounded-tr-lg  hover:bg-pink-950 cursor-pointer"> Reset Password <i className="fa-solid fa-gears"></i></Link>
        </div>
      </div>
    </>
  );
